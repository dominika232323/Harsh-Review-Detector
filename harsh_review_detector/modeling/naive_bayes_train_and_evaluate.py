...
def main():
    ...
    all_combinations = list(itertools.product(
        ...
        nb_var_smoothing_options
    ))

    for i, (max_features, ngram_range, var_smoothing) in enumerate(all_combinations, 1):
        config = {
            "model": "Naive Bayes",
        ...
        print(f"max_features: {max_features}, ngram_range: {ngram_range}, var_smoothing: {var_smoothing}")
